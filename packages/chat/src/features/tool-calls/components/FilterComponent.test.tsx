 ...
 *
 * The model sees a sample of each field's values, not all of them, so it will
 * keep naming values and fields that don't exist; the card has to explain the
 * miss and offer a fix.
 */
