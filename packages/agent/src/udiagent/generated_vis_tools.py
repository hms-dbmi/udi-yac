...
TEMPLATES = ['{"source": {"name": "<E>", "source": "<E.url>"}, "transformation": [{"groupby": "<F>"}, {"rollup": {"<E> count": '
 ...
 '"*", "left": {"agg": "max", "field": "survival days"}, "right": {"literal": 1.12}}}}, {"derive": {"full survival": '
 '{"literal": 100}}}, {"derive": {"first day": {"agg": "min", "field": "survival days"}}}, {"derive": {"lead day": '
 '{"if": {"op": "==", "left": {"window": "rank"}, "right": {"literal": 1}}, "then": {"literal": 0}, "else": {"if": '
 '{"op": "==", "left": {"window": "rank"}, "right": {"literal": 2}}, "then": {"field": "first day"}, "else": '
 '{"literal": null}}}}}, {"derive": {"rule day": {"if": {"op": "==", "left": {"window": "rank"}, "right": {"literal": '
 '1}}, "then": {"field": "label day"}, "else": {"if": {"op": "==", "left": {"field": "survival percentage"}, "right": '
 ...
 '"_label_offset"}, "right": {"literal": 1}}}}}, {"derive": {"final label": {"concat": [{"field": "final survival"}, '
 '{"literal": "%"}]}}}], "representation": [{"mark": "line", "mapping": [{"encoding": "x", "field": "lead day", '
 '"type": "quantitative", "title": "survival days", "domain": {"min": 0}}, {"encoding": "y", "field": "full survival", '
 ...
 '{"mark": "line", "mapping": [{"encoding": "x", "field": "rule day", "type": "quantitative", "title": "survival '
 'days", "domain": {"min": 0}}, {"encoding": "y", "field": "final percentage", "type": "quantitative", "domain": '
 '{"min": 0, "max": 100}}], "strokeDash": [6, 4]}, {"mark": "text", "mapping": [{"encoding": "x", "field": "label '
 'day", "type": "quantitative", "title": "survival days", "domain": {"min": 0}}, {"encoding": "y", "field": "final '
 'percentage", "type": "quantitative", "domain": {"min": 0, "max": 100}}, {"encoding": "text", "field": "final label", '
 '"type": "nominal"}], "align": "right", "dy": -9}]}',
 '{"source": {"name": "<E>", "source": "<E.url>"}, "transformation": [{"filter": {"op": "!=", "left": {"field": '
 '"<F3:q>"}, "right": {"literal": null}}}, {"derive": {"start day": {"if": {"op": "==", "left": {"field": "<F2:n>"}, '
 '"right": {"literal": "<V1>"}}, "then": {"field": "<F3>"}, "else": {"literal": null}}, "end day": {"if": {"op": "==", '
 '"left": {"field": "<F2>"}, "right": {"literal": "<V2>"}}, "then": {"field": "<F3>"}, "else": {"literal": null}}}}, '
 ...
 'day": {"op": "*", "left": {"agg": "max", "field": "survival days"}, "right": {"literal": 1.12}}}}, {"derive": {"full '
 'survival": {"literal": 100}}}, {"derive": {"first day": {"agg": "min", "field": "survival days"}}}, {"derive": '
 '{"lead day": {"if": {"op": "==", "left": {"window": "rank"}, "right": {"literal": 1}}, "then": {"literal": 0}, '
 '"else": {"if": {"op": "==", "left": {"window": "rank"}, "right": {"literal": 2}}, "then": {"field": "first day"}, '
 '"else": {"literal": null}}}}}, {"derive": {"rule day": {"if": {"op": "==", "left": {"window": "rank"}, "right": '
 ...
 '"field": "survival days", "type": "quantitative", "title": "survival days", "domain": {"min": 0}}, {"encoding": "y", '
 ...
 '"<F4>", "type": "nominal", "omitLegend": true}], "align": "right", "dy": -9}], "title": "<F4>"}',
 ...
 '"field": "survival days"}, "right": {"literal": 1.12}}}}, {"derive": {"full survival": {"literal": 100}}}, '
 '{"derive": {"first day": {"agg": "min", "field": "survival days"}}}, {"derive": {"lead day": {"if": {"op": "==", '
 '"left": {"window": "rank"}, "right": {"literal": 1}}, "then": {"literal": 0}, "else": {"if": {"op": "==", "left": '
 '{"window": "rank"}, "right": {"literal": 2}}, "then": {"field": "first day"}, "else": {"literal": null}}}}}, '
 '{"derive": {"rule day": {"if": {"op": "==", "left": {"window": "rank"}, "right": {"literal": 1}}, "then": {"field": '
 '"label day"}, "else": {"if": {"op": "==", "left": {"field": "survival percentage"}, "right": {"field": "final '
 'percentage"}}, "then": {"field": "survival days"}, "else": {"literal": null}}}}}, {"derive": {"_label_offset": '
 ...
 '{"literal": 1}}}}}, {"derive": {"final label": {"concat": [{"field": "<F4>"}, {"literal": " "}, {"field": "final '
 'survival"}, {"literal": "%"}]}}}], "representation": [{"mark": "line", "mapping": [{"encoding": "x", "field": "lead '
 'day", "type": "quantitative", "title": "survival days", "domain": {"min": 0}}, {"encoding": "y", "field": "full '
 'survival", "type": "quantitative", "domain": {"min": 0, "max": 100}}, {"encoding": "color", "field": "<F4>", "type": '
 '"nominal", "omitLegend": true}]}, {"mark": "line", "mapping": [{"encoding": "x", "field": "survival days", "type": '
 '"quantitative", "title": "survival days", "domain": {"min": 0}}, {"encoding": "y", "field": "survival percentage", '
 '"type": "quantitative", "domain": {"min": 0, "max": 100}, "title": "survival (%)"}, {"encoding": "color", "field": '
 '"<F4>", "type": "nominal", "omitLegend": true}]}, {"mark": "line", "mapping": [{"encoding": "x", "field": "rule '
 'day", "type": "quantitative", "title": "survival days", "domain": {"min": 0}}, {"encoding": "y", "field": "final '
 'percentage", "type": "quantitative", "domain": {"min": 0, "max": 100}}, {"encoding": "color", "field": "<F4>", '
 '"type": "nominal", "omitLegend": true}], "strokeDash": [6, 4]}, {"mark": "text", "mapping": [{"encoding": "x", '
 '"field": "label day", "type": "quantitative", "title": "survival days", "domain": {"min": 0}}, {"encoding": "y", '
 '"field": "final percentage", "type": "quantitative", "domain": {"min": 0, "max": 100}}, {"encoding": "text", '
 '"field": "final label", "type": "nominal"}, {"encoding": "color", "field": "<F4>", "type": "nominal", "omitLegend": '
 'true}], "align": "right", "dy": -9}], "title": "<F4>"}',
 '{"source": {"name": "<E>", "source": "<E.url>"}, "transformation": [{"groupby": ["<F2>", "<F1>"]}, {"rollup": '
