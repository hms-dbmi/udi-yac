...
TEMPLATES = ['{"source": {"name": "<E>", "source": "<E.url>"}, "transformation": [{"groupby": "<F>"}, {"rollup": {"<E> count": '
 ...
 '"*", "left": {"agg": "max", "field": "survival days"}, "right": {"literal": 1.02}}}}, {"derive": {"_label_offset": '
 ...
 '{"literal": 1}}}}}], "representation": [{"mark": "line", "mapping": [{"encoding": "x", "field": "survival days", '
 '"type": "quantitative", "title": "survival days"}, {"encoding": "y", "field": "survival percentage", "type": '
 '"quantitative", "domain": {"min": 0, "max": 100}, "title": "survival (%)"}]}, {"mark": "line", "mapping": '
 '[{"encoding": "x", "field": "survival days", "type": "quantitative", "title": "survival days"}, {"encoding": "y", '
 '"field": "final percentage", "type": "quantitative", "domain": {"min": 0, "max": 100}}], "strokeDash": [6, 4]}, '
 '{"mark": "text", "mapping": [{"encoding": "x", "field": "label day", "type": "quantitative", "title": "survival '
 'days"}, {"encoding": "y", "field": "final percentage", "type": "quantitative", "domain": {"min": 0, "max": 100}}, '
 '{"encoding": "text", "field": "final survival", "type": "quantitative"}]}]}',
 '{"source": {"name": "<E>", "source": "<E.url>"}, "transformation": [{"filter": {"op": "!=", "left": {"field": '
 '"<F3:q>"}, "right": {"literal": null}}}, {"derive": {"start day": {"if": {"op": "==", "left": {"field": "<F2:n>"}, '
 '"right": {"literal": "<V1>"}}, "then": {"field": "<F3>"}, "else": {"literal": null}}, "end day": {"if": {"op": "==", '
 '"left": {"field": "<F2>"}, "right": {"literal": "<V2>"}}, "then": {"field": "<F3>"}, "else": {"literal": null}}}}, '
 ...
 'day": {"op": "*", "left": {"agg": "max", "field": "survival days"}, "right": {"literal": 1.02}}}}, {"derive": '
 ...
 '"_label_offset"}, "right": {"literal": 1}}}}}], "representation": [{"mark": "line", "mapping": [{"encoding": "x", '
 '"field": "survival days", "type": "quantitative", "title": "survival days"}, {"encoding": "y", "field": "survival '
 'percentage", "type": "quantitative", "domain": {"min": 0, "max": 100}, "title": "survival (%)"}, {"encoding": '
 '"color", "field": "<F4>", "type": "nominal"}]}, {"mark": "line", "mapping": [{"encoding": "x", "field": "survival '
 'days", "type": "quantitative", "title": "survival days"}, {"encoding": "y", "field": "final percentage", "type": '
 '"quantitative", "domain": {"min": 0, "max": 100}}, {"encoding": "color", "field": "<F4>", "type": "nominal", '
 '"omitLegend": true}], "strokeDash": [6, 4]}, {"mark": "text", "mapping": [{"encoding": "x", "field": "label day", '
 '"type": "quantitative", "title": "survival days"}, {"encoding": "y", "field": "final percentage", "type": '
 '"quantitative", "domain": {"min": 0, "max": 100}}, {"encoding": "text", "field": "final survival", "type": '
 '"quantitative"}, {"encoding": "color", "field": "<F4>", "type": "nominal", "omitLegend": true}]}]}',
 ...
 '"field": "survival days"}, "right": {"literal": 1.02}}}}, {"derive": {"_label_offset": {"op": "+", "left": {"field": '
 '"final percentage"}, "right": {"literal": 0.5}}}}, {"derive": {"final survival": {"op": "-", "left": {"field": '
 '"_label_offset"}, "right": {"op": "%", "left": {"field": "_label_offset"}, "right": {"literal": 1}}}}}], '
 '"representation": [{"mark": "line", "mapping": [{"encoding": "x", "field": "survival days", "type": "quantitative", '
 '"title": "survival days"}, {"encoding": "y", "field": "survival percentage", "type": "quantitative", "domain": '
 '{"min": 0, "max": 100}, "title": "survival (%)"}, {"encoding": "color", "field": "<F4>", "type": "nominal"}]}, '
 ...
 '{"encoding": "text", "field": "final survival", "type": "quantitative"}, {"encoding": "color", "field": "<F4>", '
 '"type": "nominal", "omitLegend": true}]}]}',
 '{"source": {"name": "<E>", "source": "<E.url>"}, "transformation": [{"groupby": ["<F2>", "<F1>"]}, {"rollup": '
