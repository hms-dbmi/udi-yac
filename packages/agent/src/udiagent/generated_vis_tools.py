...
TEMPLATES = ['{"source": {"name": "<E>", "source": "<E.url>"}, "transformation": [{"groupby": "<F>"}, {"rollup": {"<E> count": '
 ...
 '"mapping": [{"encoding": "x", "field": "lead year", "type": "quantitative", "title": "survival years", "domain": '
 '{"min": 0}}, {"encoding": "y", "field": "full survival", "type": "quantitative", "domain": {"min": 0, "max": '
 '100}}]}, {"mark": "line", "mapping": [{"encoding": "x", "field": "drop year", "type": "quantitative", "title": '
 '"survival years", "domain": {"min": 0}}, {"encoding": "y", "field": "drop percentage", "type": "quantitative", '
 '"domain": {"min": 0, "max": 100}}]}, {"mark": "line", "mapping": [{"encoding": "x", "field": "survival years", '
 '"type": "quantitative", "title": "survival years", "domain": {"min": 0}}, {"encoding": "y", "field": "survival '
 'percentage", "type": "quantitative", "domain": {"min": 0, "max": 100}, "title": "survival (%)"}], "interpolate": '
 ...
 '"domain": {"min": 0, "max": 100}}], "strokeDash": [6, 4]}, {"mark": "text", "mapping": [{"encoding": "x", "field": '
 ...
 'label", "type": "nominal"}], "align": "right", "dy": -9, "stroke": "white", "strokeWidth": 3, "strokeOpacity": 0.7, '
 '"avoidOverlap": 8}]}',
 '{"source": {"name": "<E>", "source": "<E.url>"}, "transformation": [{"filter": {"op": "!=", "left": {"field": '
 '"<F3:q>"}, "right": {"literal": null}}}, {"derive": {"start day": {"if": {"op": "==", "left": {"field": "<F2:n>"}, '
 '"right": {"literal": "<V1>"}}, "then": {"field": "<F3>"}, "else": {"literal": null}}, "end day": {"if": {"op": "==", '
 ...
 '{"encoding": "color", "field": "<F4>", "type": "nominal", "omitLegend": true}], "interpolate": "step-after"}, '
 ...
 '{"min": 0, "max": 100}}, {"encoding": "color", "field": "<F4>", "type": "nominal", "omitLegend": true}], '
 ...
 '"representation": [{"mark": "line", "mapping": [{"encoding": "x", "field": "lead year", "type": "quantitative", '
 '"title": "survival years", "domain": {"min": 0}}, {"encoding": "y", "field": "full survival", "type": '
 '"quantitative", "domain": {"min": 0, "max": 100}}, {"encoding": "color", "field": "<F4>", "type": "nominal", '
 '"omitLegend": true}]}, {"mark": "line", "mapping": [{"encoding": "x", "field": "drop year", "type": "quantitative", '
 '"title": "survival years", "domain": {"min": 0}}, {"encoding": "y", "field": "drop percentage", "type": '
 '"quantitative", "domain": {"min": 0, "max": 100}}, {"encoding": "color", "field": "<F4>", "type": "nominal", '
 '"omitLegend": true}]}, {"mark": "line", "mapping": [{"encoding": "x", "field": "survival years", "type": '
 ...
 '"<F4>", "type": "nominal", "omitLegend": true}], "interpolate": "step-after"}, {"mark": "line", "mapping": '
 '[{"encoding": "x", "field": "rule year", "type": "quantitative", "title": "survival years", "domain": {"min": 0}}, '
 ...
 '"text", "mapping": [{"encoding": "x", "field": "label year", "type": "quantitative", "title": "survival years", '
 ...
 '[{"field": "<E2.F>"}, {"literal": " "}, {"field": "final survival"}, {"literal": "%"}]}}}], "representation": '
 ...
 '"nominal", "omitLegend": true}], "strokeDash": [6, 4]}, {"mark": "text", "mapping": [{"encoding": "x", "field": '
 '"label year", "type": "quantitative", "title": "survival years", "domain": {"min": 0}}, {"encoding": "y", "field": '
 '"final percentage", "type": "quantitative", "domain": {"min": 0, "max": 100}}, {"encoding": "text", "field": "final '
...
TOOL_DEFS = [{'function': {'description': '[barchart] Counts entities grouped by a nominal field, displayed as a vertical bar '
 ...
 {'function': {'description': '[grouped_scatter] Plots two quantitative fields as a scatterplot with points colored by '
                              ...
                              '<F3:n> groups?',
               'name': 'vis_061_grouped_scatter_by_color',
               'parameters': {'additionalProperties': False,
                              'properties': {'entity': {'description': 'The data entity (table) to visualize.',
                                                        'type': 'string'},
                                             'field1': {'description': 'quantitative field, encodes x-axis.',
 ...
 {'function': {'description': '[histogram] Shows the distribution of a quantitative field as a histogram with '
               ...
               'name': 'vis_062_histogram_distribution',
               'parameters': {'additionalProperties': False,
                              'properties': {'entity': {'description': 'The data entity (table) to visualize.',
                                                        'type': 'string'},
                                             'field': {'description': 'any type field.', 'type': 'string'}},
 ...
 {'function': {'description': '[grouped_area] Compares the distribution of a quantitative field across categories '
                              ...
                              '<F2:n>?',
               'name': 'vis_065_grouped_area_density',
               'parameters': {'additionalProperties': False,
                              'properties': {'entity': {'description': 'The data entity (table) to visualize.',
                                                        'type': 'string'},
                                             'field1': {'description': 'quantitative field, encodes x-axis.',
 ...
 {'function': {'description': '[grouped_dot] Compares the distribution of a quantitative field across categories using '
               ...
               'name': 'vis_066_grouped_dot_distribution',
               'parameters': {'additionalProperties': False,
                              'properties': {'entity': {'description': 'The data entity (table) to visualize.',
                                                        'type': 'string'},
                                             'field1': {'description': 'quantitative field, encodes x-axis.',
 ...
 {'function': {'description': '[table] Analyzes data completeness by counting and computing the percentage of records '
               ...
               'name': 'vis_067_table_count_null_nonnull',
               'parameters': {'additionalProperties': False,
                              'properties': {'entity': {'description': 'The data entity (table) to visualize.',
                                                        'type': 'string'},
                                             'field': {'description': 'any type field.', 'type': 'string'}},
...
TOOL_DISPATCH = {'vis_000_barchart_count_vert_grouped': (0, {'entity': 'E', 'field': 'F'}),
 ...
 'vis_057_line_survival_related': (57,
                                   {'entity1': 'E1',
                                    ...
                                    'value1': 'V1',
                                    'value2': 'V2'}),
 'vis_058_heatmap_count': (58, {'entity': 'E', 'field1': 'F1', 'field2': 'F2'}),
 'vis_059_heatmap_avg': (59, {'entity': 'E', 'field1': 'F1', 'field2': 'F2', 'field3': 'F3'}),
 'vis_060_heatmap_basic': (60, {'dimension1': 'D1', 'dimension2': 'D2', 'entity': 'E'}),
 'vis_061_grouped_scatter_by_color': (61, {'entity': 'E', 'field1': 'F1', 'field2': 'F2', 'field3': 'F3'}),
 'vis_062_histogram_distribution': (62, {'entity': 'E', 'field': 'F'}),
 'vis_063_area_density': (63, {'entity': 'E', 'field': 'F'}),
 'vis_064_dot_distribution': (64, {'entity': 'E', 'field': 'F'}),
 'vis_065_grouped_area_density': (65, {'entity': 'E', 'field1': 'F1', 'field2': 'F2'}),
 'vis_066_grouped_dot_distribution': (66, {'entity': 'E', 'field1': 'F1', 'field2': 'F2'}),
 'vis_067_table_count_null_nonnull': (67, {'entity': 'E', 'field': 'F'}),
 'vis_068_table_count_null': (68, {'entity': 'E', 'field': 'F'})}
...
TOOL_TAGS = {'vis_000_barchart_count_vert_grouped': ['line_item', 'barchart'],
 ...
 'vis_058_heatmap_count': ['line_item', 'heatmap'],
 'vis_059_heatmap_avg': ['line_item', 'heatmap'],
 'vis_060_heatmap_basic': ['data_cube', 'heatmap'],
 'vis_061_grouped_scatter_by_color': ['line_item', 'grouped_scatter'],
 'vis_062_histogram_distribution': ['line_item', 'histogram'],
 'vis_063_area_density': ['line_item', 'area'],
 'vis_064_dot_distribution': ['line_item', 'dot'],
 'vis_065_grouped_area_density': ['line_item', 'grouped_area'],
 'vis_066_grouped_dot_distribution': ['line_item', 'grouped_dot'],
 'vis_067_table_count_null_nonnull': ['line_item', 'table'],
 'vis_068_table_count_null': ['line_item', 'table']}
