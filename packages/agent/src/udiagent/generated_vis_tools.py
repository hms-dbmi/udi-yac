...
TEMPLATES = ['{"source": {"name": "<E>", "source": "<E.url>"}, "transformation": [{"groupby": "<F>"}, {"rollup": {"<E> count": '
 ...
 '{"derive": {"subjects": {"agg": "count"}}}, {"derive": {"died": {"if": {"op": "!=", "left": {"field": "end day"}, '
 ...
 'days"}, "right": {"literal": 0}}}, {"orderby": {"field": "survival days", "order": "asc"}}, {"derive": {"survival '
 ...
 '{"derive": {"final percentage": {"agg": "min", "field": "survival percentage"}}}, {"derive": {"label day": {"op": '
 '"*", "left": {"agg": "max", "field": "survival days"}, "right": {"literal": 1.12}}}}, {"derive": {"rule day": {"if": '
 ...
 '"mapping": [{"encoding": "x", "field": "survival days", "type": "quantitative", "title": "survival days"}, '
 '{"encoding": "y", "field": "survival percentage", "type": "quantitative", "domain": {"min": 0, "max": 100}, "title": '
 '"survival (%)"}]}, {"mark": "line", "mapping": [{"encoding": "x", "field": "rule day", "type": "quantitative", '
 '"title": "survival days"}, {"encoding": "y", "field": "final percentage", "type": "quantitative", "domain": {"min": '
 '0, "max": 100}}], "strokeDash": [6, 4]}, {"mark": "text", "mapping": [{"encoding": "x", "field": "label day", '
 '"type": "quantitative", "title": "survival days"}, {"encoding": "y", "field": "final percentage", "type": '
 ...
 '{"groupby": "<F4>"}, {"derive": {"subjects": {"agg": "count"}}}, {"derive": {"died": {"if": {"op": "!=", "left": '
 ...
 '"survival days"}, "right": {"literal": 0}}}, {"orderby": {"field": "survival days", "order": "asc"}}, {"derive": '
 ...
 'day": {"op": "*", "left": {"agg": "max", "field": "survival days"}, "right": {"literal": 1.12}}}}, {"derive": {"rule '
 'day": {"if": {"op": "==", "left": {"window": "rank"}, "right": {"literal": 1}}, "then": {"field": "label day"}, '
 '"else": {"if": {"op": "==", "left": {"field": "survival percentage"}, "right": {"field": "final percentage"}}, '
 '"then": {"field": "survival days"}, "else": {"literal": null}}}}}, {"derive": {"_label_offset": {"op": "+", "left": '
 '{"field": "final percentage"}, "right": {"literal": 0.5}}}}, {"derive": {"final survival": {"op": "-", "left": '
 '{"field": "_label_offset"}, "right": {"op": "%", "left": {"field": "_label_offset"}, "right": {"literal": 1}}}}}, '
 '{"derive": {"final label": {"concat": [{"field": "<F4>"}, {"literal": " "}, {"field": "final survival"}, {"literal": '
 '"%"}]}}}], "representation": [{"mark": "line", "mapping": [{"encoding": "x", "field": "survival days", "type": '
 '"quantitative", "title": "survival days"}, {"encoding": "y", "field": "survival percentage", "type": "quantitative", '
 '"domain": {"min": 0, "max": 100}, "title": "survival (%)"}, {"encoding": "color", "field": "<F4>", "type": '
 '"nominal"}]}, {"mark": "line", "mapping": [{"encoding": "x", "field": "rule day", "type": "quantitative", "title": '
 '"survival days"}, {"encoding": "y", "field": "final percentage", "type": "quantitative", "domain": {"min": 0, "max": '
 '100}}, {"encoding": "color", "field": "<F4>", "type": "nominal"}], "strokeDash": [6, 4]}, {"mark": "text", '
 '"mapping": [{"encoding": "x", "field": "label day", "type": "quantitative", "title": "survival days"}, {"encoding": '
 '"y", "field": "final percentage", "type": "quantitative", "domain": {"min": 0, "max": 100}}, {"encoding": "text", '
 '"field": "final label", "type": "nominal"}, {"encoding": "color", "field": "<F4>", "type": "nominal"}], "align": '
 '"left", "dx": 4, "dy": -8}]}',
 ...
 '"count"}}}, {"derive": {"died": {"if": {"op": "!=", "left": {"field": "end day"}, "right": {"literal": null}}, '
 '"then": {"literal": 1}, "else": {"literal": 0}}, "survival days": {"if": {"op": "!=", "left": {"field": "end day"}, '
 '"right": {"literal": null}}, "then": {"op": "-", "left": {"field": "end day"}, "right": {"field": "start day"}}, '
 '"else": {"literal": 0}}}}, {"filter": {"op": ">=", "left": {"field": "survival days"}, "right": {"literal": 0}}}, '
 '{"orderby": {"field": "survival days", "order": "asc"}}, {"derive": {"survival percentage": {"rolling": '
 ...
 '{"agg": "min", "field": "survival percentage"}}}, {"derive": {"label day": {"op": "*", "left": {"agg": "max", '
 '"field": "survival days"}, "right": {"literal": 1.12}}}}, {"derive": {"rule day": {"if": {"op": "==", "left": '
 '{"window": "rank"}, "right": {"literal": 1}}, "then": {"field": "label day"}, "else": {"if": {"op": "==", "left": '
 '{"field": "survival percentage"}, "right": {"field": "final percentage"}}, "then": {"field": "survival days"}, '
 '"else": {"literal": null}}}}}, {"derive": {"_label_offset": {"op": "+", "left": {"field": "final percentage"}, '
 '"right": {"literal": 0.5}}}}, {"derive": {"final survival": {"op": "-", "left": {"field": "_label_offset"}, "right": '
 '{"op": "%", "left": {"field": "_label_offset"}, "right": {"literal": 1}}}}}, {"derive": {"final label": {"concat": '
 '[{"field": "<F4>"}, {"literal": " "}, {"field": "final survival"}, {"literal": "%"}]}}}], "representation": '
 '[{"mark": "line", "mapping": [{"encoding": "x", "field": "survival days", "type": "quantitative", "title": "survival '
 'days"}, {"encoding": "y", "field": "survival percentage", "type": "quantitative", "domain": {"min": 0, "max": 100}, '
 '"title": "survival (%)"}, {"encoding": "color", "field": "<F4>", "type": "nominal"}]}, {"mark": "line", "mapping": '
 '[{"encoding": "x", "field": "rule day", "type": "quantitative", "title": "survival days"}, {"encoding": "y", '
 '"field": "final percentage", "type": "quantitative", "domain": {"min": 0, "max": 100}}, {"encoding": "color", '
 '"field": "<F4>", "type": "nominal"}], "strokeDash": [6, 4]}, {"mark": "text", "mapping": [{"encoding": "x", "field": '
 '"label day", "type": "quantitative", "title": "survival days"}, {"encoding": "y", "field": "final percentage", '
 '"type": "quantitative", "domain": {"min": 0, "max": 100}}, {"encoding": "text", "field": "final label", "type": '
 '"nominal"}, {"encoding": "color", "field": "<F4>", "type": "nominal"}], "align": "left", "dx": 4, "dy": -8}]}',
 '{"source": {"name": "<E>", "source": "<E.url>"}, "transformation": [{"groupby": ["<F2>", "<F1>"]}, {"rollup": '
